...
import { HOUSES } from "../src/features/archetype-deepdive-v2/domain/types.ts";
import fs from "fs";
const slim = {
  houses: HOUSES,
  questions: QUESTIONS_70.map(q => ({
...
console.log("wrote", slim.questions.length, "questions and", slim.houses.length, "houses");
