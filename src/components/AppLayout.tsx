...
import {
  ...
  ChevronLeft, ChevronRight, Zap, LogOut, Shield, BarChart3, BookOpen, UserCircle, CalendarDays,
} from "lucide-react";
    ...
    <div className="flex min-h-screen w-full relative z-10">
      ...
      >
        <div className="px-4 mb-10 flex items-center gap-3">
          ...
          <AnimatePresence>
            {!collapsed && (
              <motion.span initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="text-neural-title text-[11px]">
                Aegis
              </motion.span>
            )}
          </AnimatePresence>
