  ...
  return (
    <div className="flex min-h-screen w-full relative z-10">
      ...
      >
        ...
        <Link
          to="/"
          className="mx-3 mb-4 flex items-center gap-3 px-3 py-2.5 rounded-xl text-muted-foreground hover:text-foreground hover:bg-secondary/30 transition-all"
        >
              ...
              >
                {isActive && (
                  <motion.div
                    ...
                    className="absolute inset-0 rounded-xl bg-neural-accent/10 border border-neural-accent/20"
        ...
        <button onClick={signOut} className="mx-3 p-3 rounded-xl text-muted-foreground hover:text-destructive hover:bg-destructive/5 transition-colors" title="Sign out">
          <LogOut size={16} />
        </button>
