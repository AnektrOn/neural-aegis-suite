...
-- Toolbox: delegate to notify_all_admins.
...
DROP TRIGGER IF EXISTS on_journal_entry_notify_admin ON public.journal_entries;
...
DROP TRIGGER IF EXISTS on_mood_entry_notify_admin ON public.mood_entries;
...
DROP TRIGGER IF EXISTS on_habit_completion_notify_admin ON public.habit_completions;
...
DROP TRIGGER IF EXISTS on_decision_created_notify_admin ON public.decisions;
...
DROP TRIGGER IF EXISTS on_people_contact_notify_admin ON public.people_contacts;
...
DROP TRIGGER IF EXISTS on_relation_quality_notify_admin ON public.relation_quality_history;
